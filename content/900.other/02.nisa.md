...
NISAで投資信託の商品を購入するにあたり、注文を依頼した日。

この段階では注文しただけなので、決まっていることはその商品を購入することだけ。
この時の基準価格は注文の内容に全く無関係。

### 約定日

依頼した注文により、投資信託の商品が実際に購入された（約定された）日。
この日の基準価格で商品が購入される。

### 受け渡し日

約定により商品がファンドの資産に追加される日。あまり気にしなくてよいが、
ファンドの資産に追加されるまでは購入したファンドを売却できない。
